  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved lot as @lot" do
        ...
        post :create, {:lot => { "name" => "invalid value" }}, valid_session
        assigns(:lot).should be_a_new(Lot)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested lot" do
        ...
        Lot.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => lot.to_param, :lot => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the lot as @lot" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Lot.any_instance.stub(:save).and_return(false)
        put :update, {:id => lot.to_param, :lot => { "name" => "invalid value" }}, valid_session
        assigns(:lot).should eq(lot)
      end
